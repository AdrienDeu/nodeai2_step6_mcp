...
async function read_local_file({ filename }) {
...
const implementations = { get_weather, calculator, get_datetime, read_local_file }
...
export async function executeTool(name, rawArgs) {
  ...
  // Validation Zod des arguments fournis par le LLM
